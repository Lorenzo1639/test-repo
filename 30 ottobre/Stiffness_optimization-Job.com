...
options = {
    ...
    'input':'Stiffness_optimization-Job',
    'inputFormat':INP,
    'interpolExtList':['.odb', '.sim', '.SMAManifest'],
    'jleJobExcluded':False,
    'job':'Stiffness_optimization-Job',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'rezone':OFF,
    'runCalculator':OFF,
    'scratch':'C:\\Users\\Lorenzo\\Desktop\\TopOpt\\TopOpt_20251030_171349',
    'sequential':None,
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\Lorenzo\\Desktop\\TopOpt\\TopOpt_20251030_171349',
    'tracer':OFF,
